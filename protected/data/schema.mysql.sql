CREATE DATABASE  IF NOT EXISTS `feedback_test` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `feedback_test`;
-- MySQL dump 10.13  Distrib 5.5.52, for debian-linux-gnu (i686)
--
-- Host: 127.0.0.1    Database: feedback_test
-- ------------------------------------------------------
...
-- Dump completed on 2016-09-19 17:56:50